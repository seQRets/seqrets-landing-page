  ...
  return (
    <section className="relative overflow-hidden" style={{ minHeight: "90vh" }}>
      ...
      <div className="pointer-events-none absolute inset-0">
        <img
          src="/Landing_Hero_large.webp"
          alt=""
          aria-hidden="true"
          className="h-full w-full object-cover object-center"
        />
        {/* Dark overlay so text is readable — heavier on mobile */}
      ...
      <div className="relative z-[2] flex flex-col items-center justify-center text-center px-8 pt-24 pb-20" style={{ minHeight: "90vh" }}>
        ...
        <div className="mt-4 h-10 flex items-center justify-center overflow-hidden">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground/70 flex items-center gap-2 flex-wrap justify-center">
          ...
          <span>with smart cards and inheritance planning.</span>
        </p>
