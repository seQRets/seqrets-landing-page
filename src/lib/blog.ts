...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "strategy-sells-etf-outflows-drawdown-custody-stress-test",
    title: "Strategy Sold Bitcoin. ETFs Bled $4 Billion. The Drawdown Is a Custody Stress Test — and Most Setups Are Failing It Quietly.",
    date: "2026-06-06",
    category: "crypto",
    excerpt:
