...
/* ------------------------------------------------------------------ *
 * /terms — eighth interior page moved onto the redesign.
 *
 * Legal document, so restyled by mechanical substitution of colour
 * classes rather than a rewrite: no clause was retyped, and the rendered
 * text was diffed against the previous version to prove it. Effective and
 * revision dates left exactly as they were.
 *
 * The three blocks that were red — irreversibility, the "as is" warranty
 * disclaimer, and limitation of liability — take the 2px gold border
 * instead. The palette has no destructive colour, but those are the
 * clauses a reader most needs to notice, so they keep an emphasis that
 * sets them apart from ordinary sections rather than flattening in.
 * ------------------------------------------------------------------ */
        ...
        <div className="max-w-none space-y-16">
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <FileText className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Agreement to Terms
            </h2>
            <div className="rounded-2xl border border-[var(--gold-line)] bg-[var(--gold-fill)] p-6">
              <p className="text-sm text-[var(--ink2)]">
                <strong className="text-[var(--ink)]">In plain English:</strong> By using seQRets — the website, the web app, or the desktop app — you agree to these terms. If you don't agree, don't use it.
              </p>
            </div>
            <p className="text-sm text-[var(--ink2)] mt-6">
              These Terms of Service ("Terms") govern your access to and use of the seQRets website at <strong className="text-[var(--ink)]">seqrets.app</strong>, the web application at <strong className="text-[var(--ink)]">app.seqrets.app</strong>, and the seQRets desktop application (collectively, the "Services"). The Services are operated by <strong className="text-[var(--ink)]">Toothjockey LLC</strong>, a North Dakota limited liability company ("Toothjockey," "we," "us," or "our"). "seQRets" is a product of Toothjockey LLC. By accessing or using any of our Services, you agree to be bound by these Terms. If you do not agree, you must discontinue use immediately.
            </p>
            <p className="text-sm text-[var(--ink2)] mt-4">
              The seQRets application presents these Terms through a versioned acceptance gate. You must affirmatively accept the then-current version of these Terms before using the application. Your acceptance is recorded by version. See <em className="text-[var(--ink)]">Changes to These Terms</em> below for how material changes trigger renewed acceptance.
            </p>
          </section>
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <Shield className="h-7 w-7 text-[var(--gold)] shrink-0" />
              What seQRets Does
            </h2>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> seQRets encrypts your secrets, splits them into multiple QR-code shares ("Qards"), and lets you distribute them. Everything runs on your device. We have no ability to access, recover, or view your data — ever.
              </p>
              <p className="text-sm text-[var(--ink2)] mb-4">
              ...
              <p className="text-sm text-[var(--ink2)]">
                All cryptographic operations occur entirely on your device — in an isolated browser Web Worker on the web app, and in native Rust code on the desktop app. <strong className="text-[var(--ink)]">Toothjockey operates no server backend that processes, stores, transmits, or has access to your secrets, passwords, keyfiles, shares, Qards, or any cryptographic material.</strong> The core application has no user accounts, no identity verification, and collects no user data. Because we never possess your material, <strong className="text-[var(--ink)]">we cannot recover, reset, restore, decrypt, or reconstruct anything for you.</strong> If you lose your Qards, password, or keyfile below your chosen recovery threshold, your secret is permanently unrecoverable by anyone, including us.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> You must be an adult with the legal capacity to enter a contract, and you must use seQRets only where it's legal to do so.
              </p>
              <p className="text-sm text-[var(--ink2)]">
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <Scale className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Your Responsibilities & Assumption of Risk
            </h2>
            <div className="rounded-2xl border-2 border-[var(--gold)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> You — and only you — are responsible for your secrets, passwords, keyfiles, and Qard shares. If you lose them, they're gone forever. We can't help you recover anything. That's the design, not a defect.
              </p>
              <p className="text-sm text-[var(--ink2)] mb-4">
              ...
              <ul className="space-y-3 text-sm text-[var(--ink2)]">
                <li className="flex items-start gap-2">
                  <span className="text-[var(--gold)] mt-0.5">•</span>
                  <span><strong className="text-[var(--ink)]">Passwords and keyfiles:</strong> You are solely responsible for choosing, remembering, and securely storing the passwords and any keyfiles used to encrypt your secrets. There is no password reset and no recovery mechanism of any kind.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--gold)] mt-0.5">•</span>
                  <span><strong className="text-[var(--ink)]">Share custody and distribution:</strong> You are solely responsible for the safekeeping and distribution of your Qard shares. If you lose enough shares to fall below your chosen reconstruction threshold, your secret is permanently irrecoverable.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--gold)] mt-0.5">•</span>
                  <span><strong className="text-[var(--ink)]">Backups:</strong> You are solely responsible for creating and maintaining adequate backups of your secrets, shares, and any information needed to reconstruct them. We maintain no backups and have no copy of anything.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--gold)] mt-0.5">•</span>
                  <span><strong className="text-[var(--ink)]">Device security:</strong> You are responsible for ensuring that any device on which you run seQRets is free from malware, compromised browser extensions, keyloggers, screen capture, and other threats, and that your operating environment is trustworthy.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--gold)] mt-0.5">•</span>
                  <span><strong className="text-[var(--ink)]">Lawful use:</strong> You are responsible for using the Services only for lawful purposes and in compliance with all laws and regulations applicable to you.</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <Info className="h-7 w-7 text-[var(--gold)] shrink-0" />
              No Professional Advice
            </h2>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> seQRets is a software tool, not an advisor. We don't give financial, investment, legal, tax, or estate-planning advice. Talk to a licensed professional for that.
              </p>
              <p className="text-sm text-[var(--ink2)]">
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <Ban className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Acceptable Use
            </h2>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> Don't use seQRets to break the law or to attack, abuse, or misrepresent the software.
              </p>
              <p className="text-sm text-[var(--ink2)] mb-4">
              ...
              <p className="text-sm text-[var(--ink2)] mt-4">
                Lawful security research and review of the open-source code in accordance with its license are permitted and encouraged. Responsible disclosure of vulnerabilities is welcomed at <a href="mailto:security@seqrets.app" className="text-[var(--gold)] hover:underline">security@seqrets.app</a>.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <AlertTriangle className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Disclaimer of Warranties
            </h2>
            <div className="rounded-2xl border-2 border-[var(--gold)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> seQRets is provided "as is." It's software that hasn't been independently audited yet. We believe the cryptography is sound — the code is open source and uses well-established primitives — but we make no guarantees. Use it at your own risk.
              </p>
              <p className="text-sm text-[var(--ink2)] uppercase font-semibold">
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <Gavel className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Limitation of Liability
            </h2>
            <div className="rounded-2xl border-2 border-[var(--gold)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> We are not liable if you lose access to your secrets, lose cryptocurrency, or suffer any other loss from using seQRets. Because we have zero access to your data, we have zero ability to help recover it — and our total liability to you is capped.
              </p>
              <p className="text-sm text-[var(--ink2)] mb-4 uppercase font-semibold">
              ...
              <p className="text-sm text-[var(--ink2)]">
                <strong className="text-[var(--ink)]">Aggregate cap.</strong> To the maximum extent permitted by applicable law, the total aggregate liability of Toothjockey LLC arising out of or relating to the Services and these Terms shall not exceed <strong className="text-[var(--ink)]">zero U.S. dollars (US$0.00)</strong>. The Services are provided to you free of charge, and you acknowledge that this allocation of risk — including a zero-dollar liability cap — is a fundamental basis of the bargain between you and Toothjockey and is reflected in the decision to provide the Services at no cost. Some jurisdictions do not allow the limitation or exclusion of liability for certain damages, so some of the above limitations may not apply to you; in those jurisdictions, our liability is limited to the smallest amount permitted by law. Nothing in these Terms excludes or limits liability that cannot be excluded or limited under applicable law.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <ShieldOff className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Indemnification
            </h2>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> If your misuse of seQRets causes a legal problem for us, you agree to cover the resulting costs.
              </p>
              <p className="text-sm text-[var(--ink2)]">
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <Code className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Open Source License
            </h2>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> The source code is open source under AGPLv3 (or any later version). You can read, audit, fork, and modify it — subject to that license. Commercial licensing is available separately.
              </p>
              <p className="text-sm text-[var(--ink2)] mb-3">
                The seQRets source code is released under the <strong className="text-[var(--ink)]">GNU Affero General Public License, version 3 or any later version (AGPL-3.0-or-later)</strong>. You may use, copy, modify, and distribute the source code in accordance with that license. The full license text is available in the project's <a href="https://github.com/seQRets/seQRets-app" target="_blank" rel="noopener noreferrer" className="text-[var(--gold)] hover:underline">GitHub repository</a>. These Terms govern your use of the Services we operate; the AGPL governs your rights in the source code itself. In the event of a conflict between these Terms and the AGPL with respect to the source code, the AGPL controls as to the code.
              </p>
              <p className="text-sm text-[var(--ink2)]">
                For commercial licensing inquiries (use in proprietary products, enterprise deployments, or contexts where AGPL obligations are not feasible), contact <a href="mailto:licensing@seqrets.app" className="text-[var(--gold)] hover:underline">licensing@seqrets.app</a>.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <ShoppingBag className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Purchases
            </h2>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> The desktop app and physical accessories are paid products. When the shop launches, purchases will be handled through a third-party payment processor. We'll add specific purchase terms at that time.
              </p>
              <p className="text-sm text-[var(--ink2)]">
          ...
          <section>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <h2 className="font-display text-xl font-bold text-[var(--ink)] mb-3">Intellectual Property</h2>
              <p className="text-sm text-[var(--ink2)]">
          ...
          <section>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <h2 className="font-display text-xl font-bold text-[var(--ink)] mb-3">Termination</h2>
              <p className="text-sm text-[var(--ink2)]">
                Because the core application has no accounts, there is nothing to "terminate" in the traditional sense. You may stop using the Services at any time. We reserve the right to modify, suspend, or discontinue the Services (or any part of them) at any time, with or without notice. Because the software is open source, the cryptographic tools remain available to the community regardless of the status of our hosted Services. The provisions of these Terms that by their nature should survive termination — including <em className="text-[var(--ink)]">Your Responsibilities & Assumption of Risk</em>, <em className="text-[var(--ink)]">Disclaimer of Warranties</em>, <em className="text-[var(--ink)]">Limitation of Liability</em>, <em className="text-[var(--ink)]">Indemnification</em>, and <em className="text-[var(--ink)]">Governing Law & Venue</em> — survive.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--ink)] mb-8 flex items-center justify-center gap-3">
              <Building2 className="h-7 w-7 text-[var(--gold)] shrink-0" />
              Governing Law &amp; Venue
            </h2>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">In plain English:</strong> These terms are governed by North Dakota law. Most disputes are resolved by binding arbitration in Cass County, North Dakota, individually rather than as a class action.
              </p>
              <p className="text-sm text-[var(--ink2)] mb-4">
                These Terms and any dispute arising out of or relating to them or the Services are governed by the laws of the <strong className="text-[var(--ink)]">State of North Dakota, USA</strong>, without regard to its conflict-of-law principles. Subject to the arbitration provision below, you agree that the exclusive venue for any dispute shall be the state and federal courts located in <strong className="text-[var(--ink)]">Cass County, North Dakota</strong>, and you consent to the personal jurisdiction of those courts. If you access the Services from outside the United States, you are responsible for compliance with your local laws.
              </p>
              <p className="text-sm text-[var(--ink2)] mb-4">
                <strong className="text-[var(--ink)]">Binding arbitration.</strong> Except for claims that qualify for small-claims court and claims seeking injunctive relief for infringement or misuse of intellectual property, you and Toothjockey agree to resolve any dispute arising out of or relating to these Terms or the Services through final and binding arbitration, rather than in court. The arbitration will be seated in <strong className="text-[var(--ink)]">Cass County, North Dakota</strong>, conducted in English, and governed by North Dakota law. Judgment on the arbitration award may be entered in any court of competent jurisdiction. You and Toothjockey each waive the right to a trial by jury.
          ...
          <section>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-6">
              <h2 className="font-display text-xl font-bold text-[var(--ink)] mb-3">Severability &amp; Entire Agreement</h2>
              <p className="text-sm text-[var(--ink2)] mb-3">
          ...
          <section>
            <div className="rounded-2xl border border-[var(--line)] bg-[var(--sf)] p-8 flex items-start gap-6">
              ...
              <div>
                <h2 className="font-display text-xl font-bold text-[var(--ink)] mb-2">Questions or Legal Notices</h2>
                ...
                <p className="text-sm text-[var(--ink2)] mt-3">
